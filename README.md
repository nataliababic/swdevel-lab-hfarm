...
> **NOTE:** Note that for the funct3.py file the coverage rate is 94%, and not 100%, due to the fact that it recalls some functions that are in the csv_cleaning.py module and were tested in test_csv_cleaning.py. 
